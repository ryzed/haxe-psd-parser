...
class PSDLayer 
{
	public static inline var LayerType_FOLDER_OPEN 	: String = "folder_open";
	public static inline var LayerType_FOLDER_CLOSED : String = "folder_closed";
	public static inline var LayerType_HIDDEN 		: String = "hidden";
	public static inline var LayerType_NORMAL 		: String = "normal";
	...
	public var channelsInfo_arr			: Array<PSDChannelInfoVO>;
	public var blendModeKey				: String;
	public var blendMode				: BlendMode;
	public var alpha					: Float;
	public var maskBounds				: Rectangle;
	public var maskBounds2				: Rectangle;	
	public var clippingApplied			: Bool;
	public var isLocked					: Bool;
	public var isVisible				: Bool;
	public var pixelDataIrrelevant		: Bool;
	public var nameUNI					: String; //layer unicode name		
	public var filters_arr				: Array<BitmapFilter>; //filters array	
	...
	private function readLayerBasicInfo() : Void 
	{
		...
		*/
		...
		if (sig != "8BIM") throw ("Invalid Blend mode signature: " + sig ); 
		...
		*/
		...
		while (fileData.position - pos < extraSize) 
		{
			...
			//check signature
			if (sig != "8BIM") throw ("layer information signature error");
	...
	private function parseLayerEffects() :Void
	{
		...
		for(i in 0...numEffects)
		{
			...
			//check signature
			if (sig != "8BIM") throw ("layer effect information signature error");
	...
	private function parseGlow(fileData:ByteArray, inner:Bool = false):Void
	{
		...
		if (blendSig != "8BIM") throw ("Invalid Blend mode signature for Effect: " + blendSig ); 
		...
		*/
		...
		var effectIsEnabled = fileData.readBoolean();			//1 Effect enabled
		
		var alpha : Float		= fileData.readUnsignedByte() /255;	 					//1 Opacity as a percent
		
		if (ver == 2)
		{
			if (inner) var invert = fileData.readBoolean();	
	...
	private function parseDropShadow(fileData:ByteArray, inner:Bool = false):Void
	{
					//4 Size of the remaining items: 41 or 51 (depending on version)
		var ver				:Int 	= fileData.readInt(); 			//0 (Photoshop 5.0) or 2 (Photoshop 5.5)
		var blur			:Int 	= fileData.readShort();			//Blur value in pixels (8)
		...
		*/
		...
		var useInAllEFX = fileData.readBoolean();				//1 Use this angle in all of the layer effects
